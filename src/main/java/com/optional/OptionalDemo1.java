...
public class OptionalDemo1 {
	...
	public static void main(String[] args) {
		...
		//System.out.println("ob1.isEmpty()? "+ob1.isEmpty());	// --> available in JDK 11 
		...
		//System.out.println("ob2.isEmpty()? "+ob2.isEmpty());	// --> available in JDK 11
		...
		//System.out.println("ob3.isEmpty()? "+ob3.isEmpty());	// --> available in JDK 11
